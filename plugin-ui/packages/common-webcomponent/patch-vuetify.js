...
glob("../../node_modules/vuetify/lib/mixins/detachable/index.js", null, (err, files) => {
  if (err) {
...
glob("../../node_modules/vuetify/lib/mixins/overlayable/index.js", null, (err, files) => {
  if (err) {
    return console.error(err);
  } else {
    replace(
...
glob("../../node_modules/vuetify/lib/components/VSlider/VSlider.js", null, (err, files) => {
  if (err) {
    return console.error(err);
  } else {
    replace(
